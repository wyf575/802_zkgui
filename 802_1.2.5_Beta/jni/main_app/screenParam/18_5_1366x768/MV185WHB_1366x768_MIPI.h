...
#define HBP				80
#define HFP				80
#define HTOTAL  	(1368+HPSW+HBP+HFP)
#define VPSW			9
#define VBP				20
#define VFP				9
#define VTOTAL 		(768+VPSW+VBP+VFP)

#define CLK				(HTOTAL*VTOTAL*60/1000000+1)

MI_PANEL_ParamConfig_t stPanelParam =
{
    "MV185WHB_1366x768_60", // const char *m_pPanelName;                ///<  PanelName
    ...
    1368,  //MS_U16 m_wPanelWidth;                    ///< PANEL_WIDTH, DE width (VOP_05[11:0] = HEnd = HStart + Width - 1)
    768,  //MS_U16 m_wPanelHeight;                   ///< PANEL_HEIGHT, DE height (VOP_07[11:0], = Vend = VStart + Height - 1)
...
MI_PANEL_MipiDsiConfig_t stMipiDsiConfig =
{
   //HsTrail HsPrpr HsZero ClkHsPrpr ClkHsExit ClkTrail ClkZero ClkHsPost DaHsExit ContDet
    ...
    1368,   HPSW,   HBP,  HFP,  768, VPSW,   VBP,  VFP,    0,    60,
