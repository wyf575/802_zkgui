...
#define HBP				24
#define HFP				192
#define HTOTAL  	(1440+HPSW+HBP+HFP)
#define VPSW			3
#define VBP				6
#define VFP				41
#define VTOTAL 		(900+VPSW+VBP+VFP)

#define CLK				(HTOTAL*VTOTAL*60/1000000+1)

MI_PANEL_ParamConfig_t stPanelParam =
{
    "M190_1440x900_60", // const char *m_pPanelName;                ///<  PanelName
...
MI_PANEL_MipiDsiConfig_t stMipiDsiConfig =
{
    ...
    1440,   HPSW, HBP,  HFP,  900, VPSW,VBP, VFP,   0,    60,
